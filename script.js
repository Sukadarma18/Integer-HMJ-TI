...
*/
// ▼▼▼ TAMBAHKAN KODE INI DI BAGIAN AKHIR FILE SCRIPT.JS ANDA ▼▼▼
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Cek apakah elemen hamburger ada di halaman
    if (hamburger && navMenu) {
        ...
        // Tambahkan tombol auth ke sidebar untuk mobile/tablet
        function addAuthButtonsToSidebar() {
            const navMenu = document.querySelector('.nav-menu');
            const existingAuthInSidebar = navMenu.querySelector('.nav-auth');
            
            // Hapus tombol auth yang sudah ada di sidebar (jika ada)
            if (existingAuthInSidebar) {
                existingAuthInSidebar.remove();
            }
            
            // Tambahkan tombol auth ke sidebar
            ...
            // Tambahkan event listener untuk tombol auth di sidebar
            const authButtons = authContainer.querySelectorAll('.btn');
        ...
        // Panggil fungsi untuk menambahkan tombol auth ke sidebar
        addAuthButtonsToSidebar();
        ...
        document.addEventListener('click', (e) => {
            ...
            // Cek apakah klik di dalam sidebar atau pada hamburger
            ...
            // Jika klik di luar sidebar dan bukan pada hamburger, tutup menu
            if (!isClickInsideNav && !isClickOnHamburger) {
                console.log('Closing menu - click outside');
                closeMenu();
            }
        });

        // Tutup menu saat klik pada overlay (area gelap)
        navMenu.addEventListener('click', (e) => {
            // Jika klik pada elemen ::before (overlay), tutup menu
            if (e.target === navMenu) {
                closeMenu();
            }
        });

        // Tutup menu saat escape key ditekan
        ...
        // Alternatif: Tutup menu saat klik pada window (lebih reliable)
